// Minimal inline SVG icons so no extra dependency (e.g. lucide-react) is required.
// Usage: <Icon.Users size={18} />
const base = (props) => ({
  width: props.size || 18,
...
export const Icon = {
  ...
  EyeOff: (p) => (
    <svg {...base(p)}><path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a21.6 21.6 0 0 1 5.06-6.06M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a21.6 21.6 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" /><line x1="1" y1="1" x2="23" y2="23" /></svg>
  ),
  Mail: (p) => (
  ...
  Help: (p) => (
    <svg {...base(p)}><circle cx="12" cy="12" r="10" /><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 2-3 4" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>
  ),
  Layers: (p) => (
  ...
  Building: (p) => (
    <svg {...base(p)}><rect x="4" y="2" width="16" height="20" rx="1" /><line x1="9" y1="6" x2="9" y2="6" /><line x1="15" y1="6" x2="15" y2="6" /><line x1="9" y1="10" x2="9" y2="10" /><line x1="15" y1="10" x2="15" y2="10" /><line x1="9" y1="14" x2="9" y2="14" /><line x1="15" y1="14" x2="15" y2="14" /></svg>
  ),
  FileText: (p) => (
